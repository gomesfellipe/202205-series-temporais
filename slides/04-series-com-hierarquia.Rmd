...
- Queremos prever $y_t$ diretamente e reconstituir $y_t^{GRUPO}$ com alguma fórmula, como por exempo: $y_t = 5\% \times y_t^{GRUPO}$
- Queremos prever $y_t^{SUD}, y_t^{SUL}, ...$ etc, reconstituir $y_t$ a partir das fórmulas, enquanto pros estados aplicamos uma fórmula
