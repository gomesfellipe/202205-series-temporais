...
Um jeito de analisar séries temporais, inclusive de produzir previsões é aplicar o que se chama normalmente de decomposição STL, que tenta ajustar funções muito flexíveis na esquação abaixo:

$$X(t) = S(t) + T(t) + E(t).$$

Aqui teremos $S(t)$ sendo ua componente sazonal periódica, $T(t)$ é algo que aumenta ao longo do tempo.
